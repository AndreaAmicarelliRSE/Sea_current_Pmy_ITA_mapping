...
!-------------------------------------------------------------------------------
!-------------------------------------------------------------------------------
! Description: This tool reads the output files on marine current yearly average
!              power from “Sea current Py mapping (RSE SpA)” and provides:
...
P_min = 1000.
write(*,*)                                                                     &
'This tool reads the output files on marine current yearly average power ',    &
'from “Sea current Py mapping (RSE SpA)” and provides: ',                      &
"   1) the multiple year average of the specific power flow; ",                &
